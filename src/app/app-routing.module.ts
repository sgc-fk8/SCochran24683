...
import {PopularLineWithCountComponent } from './popular-and-count/popular-and-count.component';
...
const routes: Routes = [
  ...
  { path: 'linesOfBusinessWithCount', component: PopularAndCountComponent }
];
